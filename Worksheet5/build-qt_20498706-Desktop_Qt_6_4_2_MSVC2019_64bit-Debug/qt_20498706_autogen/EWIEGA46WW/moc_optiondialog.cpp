...
#include <memory>
#include "../../../qt_20498706/optiondialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_OptionDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_OptionDialog_t qt_meta_stringdata_OptionDialog = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_OptionDialog[] = {
...
Q_CONSTINIT const QMetaObject OptionDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_OptionDialog.offsetsAndSizes,
    qt_meta_data_OptionDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_OptionDialog_t,
        // Q_OBJECT / Q_GADGET
